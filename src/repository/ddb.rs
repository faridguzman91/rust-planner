...
impl DDBRepository {
    ...
    pub async fn get_task(&self, task_id: String) -> Option<Task> {
        ...
        let res = self
            ...
            .expression_attibute_names("#pK", "pk")
            .expression_attibute_names("sK", "sK")
            .expression_attibute_values(":user_id", user_uuid)
            .expression_attibute_values(":task_uuid", task_uuid)
            .send()
            .await;
